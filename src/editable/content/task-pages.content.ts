...
export const taskPageVoices = {
  ...
  classified: {
    ...
    headline: 'Find the right offer without the noise.',
    description: 'Browse products, services, roles, rentals, and timely opportunities with practical details at a glance.',
    filterLabel: 'Filter classified category',
    secondaryNote: 'Compare the useful details and open any post for the complete offer.',
    chips: ['Products & services', 'Jobs & hiring', 'Rentals & offers'],
  },
  sbm: {
  ...
  profile: {
    ...
    headline: 'Meet the people and organizations behind the work.',
    description: 'Explore professional backgrounds, organizations, expertise, and contact information through clear identity-led pages.',
    filterLabel: 'Filter profile category',
    secondaryNote: 'Understand experience and focus before making contact.',
    chips: ['People', 'Organizations', 'Professional expertise'],
  },
  pdf: {
