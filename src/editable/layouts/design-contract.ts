...
export const editableRootStyle = {
  ...
  '--slot4-page-bg': '#f3f5f6',
  '--slot4-page-text': '#111318',
  '--slot4-panel-bg': '#e9eef4',
  '--slot4-surface-bg': '#ffffff',
  '--slot4-muted-text': '#58616e',
  '--slot4-soft-muted-text': '#7b8490',
  '--slot4-accent': '#3457ff',
  '--slot4-accent-fill': '#3457ff',
  '--slot4-accent-soft': '#e6ebff',
  '--slot4-on-accent': '#ffffff',
  '--slot4-dark-bg': '#17191d',
  '--slot4-dark-text': '#ffffff',
  '--slot4-media-bg': '#dfe6ed',
  '--slot4-cream': '#ffffff',
  '--slot4-warm': '#edf1f3',
  '--slot4-lavender': '#e8edff',
  '--slot4-gray': '#e9eef1',
  '--slot4-body-gradient': 'none',
  '--editable-page-bg': '#f3f5f6',
  '--editable-page-text': '#111318',
  '--editable-container': '1544px',
  '--editable-border': '#d6dce2',
  '--editable-nav-bg': '#f3f5f6',
  '--editable-nav-text': '#111318',
  '--editable-nav-active': '#3457ff',
  '--editable-nav-active-text': '#ffffff',
  '--editable-cta-bg': '#17191d',
  '--editable-cta-text': '#ffffff',
  '--editable-search-bg': '#ffffff',
  '--editable-footer-bg': '#17191d',
